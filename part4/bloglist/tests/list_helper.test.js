...
describe('totalLikes', () => {
  ...
  test('when list has only no blogs, equals 0', () => {
...
describe('favoriteBlog', () => {
  ...
  test('when list has only no blogs, equals undefined', () => {
...
describe('mostLikes', () => {
  test('when list has only one blog, equals that author and count likes', () => {
